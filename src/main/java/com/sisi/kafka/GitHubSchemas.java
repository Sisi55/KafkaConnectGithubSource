...
public class GitHubSchemas {
    ...
    public static final String SCHEMA_KEY = "com.sisi.kafka.connect.github.IssueKey";
    public static final String CHEMA_VALUE_ISSUE = "com.sisi.kafka.connect.github.IssueValue";
    public static final String SCHEMA_VALUE_USER = "com.sisi.kafka.connect.github.UserValue";
    public static final String SCHEMA_VALUE_PR = "com.sisi.kafka.connect.github.PrValue";
    ...
    public static final Schema PR_SCHEMA = SchemaBuilder.struct()
    ...
    private static final String SCHEMA_VALUE_ISSUE = "com.sisi.kafka.connect.github.IssueValue";
