...
import com.sisi.kafka.Validators.BatchSizeValidator;
import com.sisi.kafka.Validators.TimestampValidator;
...
public class GitHubSourceConnectorConfig extends AbstractConfig {
    ...
    public static ConfigDef conf() {
        return new ConfigDef()
                ...
                .define(AUTH_USERNAME_CONFIG, Type.STRING, "",
                        Importance.HIGH, AUTH_USERNAME_DOC)
                .define(AUTH_PASSWORD_CONFIG, Type.PASSWORD, "",
                        Importance.HIGH, AUTH_PASSWORD_DOC);
    }
